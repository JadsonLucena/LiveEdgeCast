...
kubectl delete scaledobject worker-scaler -n media 2>/dev/null && print_success "Worker ScaledObject deleted" || print_warning "No Worker ScaledObject found"
kubectl delete scaledobject proxy-scaler -n media 2>/dev/null && print_success "Proxy ScaledObject deleted" || print_warning "No Proxy ScaledObject found"
