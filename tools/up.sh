...
# The images intentionally use a local `latest` tag. Force a new controller
# pod so an upgrade cannot keep running the previously loaded image.
print_step "Restarting the controller with the rebuilt image..."
