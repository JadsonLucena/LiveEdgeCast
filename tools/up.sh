...
echo "         -c:v libx264 -preset veryfast -pix_fmt yuv420p -r 30 -g 60 -keyint_min 60 \\"
echo "         -sc_threshold 0 -bf 2 -refs 1 -coder 1 \\"
echo "         -b:v 10000k -minrate 10000k -maxrate 10000k -bufsize 20000k \\"
